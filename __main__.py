...
#-------------------------------- Main Program ---------------------------------------------------------
    ...
    print(f"\033[1;31mPCA & LA1 collaboration will revoke the following certificate: {revoke(PC_mali,LA1,PCA)}, after a malicious behaviour stated by {PC_mali}\033[0m")
